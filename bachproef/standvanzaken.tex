...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth,height=0.45\textheight,keepaspectratio]{chatgpt_srt_explanation.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth,height=0.45\textheight,keepaspectratio]{chatgpt_topology_mediav.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\linewidth,height=0.55\textheight,keepaspectratio]{chatgpt_plg_stack.png}
