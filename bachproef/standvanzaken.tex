...
Voor dit onderzoek werd daarom gekozen voor Prometheus als metrics-backend, Grafana als visualisatieplatform en Loki voor log-aggregatie. Custom Python exporters werden ontwikkeld om data uit de InControl2 API, SRT-encoders en NDI SDK om te zetten naar het Prometheus-formaat.
